 ...
 */
export async function uploadImageAttachment(recordId, attachmentFieldName, base64Image, filename, contentType = 'image/jpeg') {
  try {
    ...
    const uploadResponse = await fetch(`https://content.airtable.com/v0/${baseId}/${recordId}/${attachmentFieldName}/uploadAttachment`, {
      method: 'POST',
      headers: {
