...
<div class="sample-room">
  ...
  <img src="landing/stickynote.png" class="room-stickynote"
  ...
  <img src="landing/cat.png" class="room-cat" 
...
.room-cat, .room-stickynote {
  transition: filter 0.2s;
}

.room-cat:hover, .room-stickynote:hover {
